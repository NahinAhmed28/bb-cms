<?php return array(
     ...
     */
    'site' => [
        'name' => 'FID - Bangladesh Bank', // used in email subjects & admin meta title, also can be referenced as %site_name% in metas
    ...
    'admin' => [
        ...
        //'help_link' => 'https://bbfinance.samsil.pro/user-manual', // help url in admin
         'help_link' => 'https://bb.mccltd.info/user-manual', // help url in admin
